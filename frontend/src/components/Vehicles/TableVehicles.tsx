...
import { fetch, deleteItem } from '../../stores/vehicles/vehiclesSlice';
...
const TableSampleVehicles = ({ filterItems, setFilterItems, filters }) => {
  ...
  const { vehicles, loading, count } = useAppSelector(
  ...
  const vehiclesPaginated = Array.from(
  ...
  const handleDeleteAction = async () => {
    if (id) {
      ...
      setIsModalTrashActive(false);
      notify('success', 'Vehicles was deleted!');
    }
  };
          ...
          {vehicles &&
            ...
            vehicles.map((item: any) => (
              ...
              >
                ...
                <td data-label='plate_number'>{item.plate_number}</td>

                <td data-label='owner_id'>
                  {dataFormatter.usersOneListFormatter(item.owner_id)}
                </td>
...
export default TableSampleVehicles;
